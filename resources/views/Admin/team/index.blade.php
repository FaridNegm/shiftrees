...
@section('content')
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <a href="{{ url('admin/add_team') }}" class="btn bg-teal-400 btn-labeled btn-rounded pull-right" ><b><i class=" icon-plus-circle2"></i></b>{{ trans('app.New') }}</a>
        </div>
        ...
        <table class="table table-bordered table-hover datatable-highlight">
            <thead>
                <tr>
                    ...
                    <th>{{ trans('app.job_ar') }}</th>
                    <th>{{ trans('app.job_en') }}</th>
