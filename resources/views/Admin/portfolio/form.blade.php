...
@section('content')
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">{{ trans('app.home') }}</span> - {{ trans('app.Portfolio') }}</h4>
            </div>
        </div>
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="">{{ trans('app.Portfolio') }}</li>
                {{--  @if(isset($find))
    ...
    <div class="panel panel-flat">
        ...
        @endif
            ...
            <form action="{{ isset($find) ? url('admin/edit_portfolio/'.$find->id) : url('admin/add_portfolio') }}" method="post" class="form-horizontal" enctype='multipart/form-data' style="margin:20px;">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <textarea id="article-ckeditor" class="form-control{{ $errors->has('description_ar') ? ' is-invalid' : '' }}" name="description_ar" rows="6" placeholder="{{ trans('app.description_ar') }}" >{{ isset($find->description_ar) ? $find->description_ar : ''}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <select id="type" class="form-control {{ $errors->has('type') ? ' is-invalid' : '' }}" name="type" >
                            ...
                            <option value="web_designer">Web Desigber</option>
                            <option value="mobile_app">Mobile App</option>
                            <option value="corbit_id">Corbit Id </option>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="url">{{ trans('app.Url') }}</label>
                    <div class="col-md-9">
                        <input id="url" type="text" class="form-control{{ $errors->has('url') ? ' is-invalid' : '' }}" name="url" value="{{ isset($find->url) ? $find->url : ''}}"  placeholder="{{ trans('app.Url') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        @if(isset($find))
                            <img src="{{ url('Admin/images/portfolio/'.$find->image) }}" name="df_image" style="width:80px;height:80px;"/>
