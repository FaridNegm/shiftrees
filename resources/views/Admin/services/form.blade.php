...
@section('content')
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">{{ trans('app.home') }}</span> - {{ trans('app.Service') }}</h4>
            </div>
        </div>
    ...
    <div class="panel panel-flat">
        ...
        @endif
            ...
            <form action="{{ isset($find) ? url('admin/edit_services/'.$find->id) : url('admin/add_services/ar') }}" method="post" class="form-horizontal" enctype='multipart/form-data' style="margin:20px;">
                @csrf

                <div class="form-group">
                    <label class="control-label col-sm-3" for="title_ar">{{ trans('app.title_ar') }}</label>
                    <div class="col-md-9">
                        <input id="title_ar" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title_ar" value="{{ isset($find->title_ar) ? $find->title_ar : ''}}" required placeholder="{{ trans('app.title_ar') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        @if(isset($find))
                            <img src="{{ url('Admin/images/service/'.$find->image) }}" name="df_image" style="width:80px;height:80px;"/>
